        ...
        <div class="u-expanded-width u-table u-table-responsive u-table-1">
          <table class="u-table-entity">
            ...
            <thead class="u-palette-4-base u-table-header u-table-header-1">
              <tr style="height: 0px;">
                <th class="u-border-1 u-border-palette-4-base u-table-cell">번호(row)</th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">제목(title)</th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">작성일(date)</th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">작성자(writer)</th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">조회수(viewcount)</th>
              </tr>
            </thead>
            <tbody class="u-table-body">
              <tr style="height: 0px;">
                ...
                <td class="u-border-1 u-border-grey-30 u-table-cell">Description</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">Description</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">dsfㅎ</td>
              </tr>
            </tbody>
          </table>
        </div>
